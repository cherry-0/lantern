...
_ENV_SPEC = EnvSpec(
    ...
    python="3.10",
    install_cmds=[["pip", "install", "tensorflow-macos", "pillow", "numpy"]],
)
...
class SkinDiseaseAdapter(BaseAdapter):
    ...
    def _run_native(self, input_item: Dict[str, Any]) -> AdapterResult:
        """Run the three TFLite models inside the 'skin-disease-detection' conda env."""
        ...
        structured = {k: result[k] for k in ("cancer", "allergy", "melanoma") if k in result}
